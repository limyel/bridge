 ...
 */
public class ConnectedHandler extends SimpleChannelInboundHandler<ConnectedPacket> {

    private ChannelGroup channelGroup = new DefaultChannelGroup(GlobalEventExecutor.INSTANCE);

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, ConnectedPacket msg) throws Exception {
        // todo 校验是否注册成功
